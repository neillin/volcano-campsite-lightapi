...
public class CampsitePostHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(CampsitePostHandlerTest.class);
    ...
    @Test
    public void testCampsitePostHandlerTest() throws ClientException {
        ...
        String requestUri = "/api/campsite";

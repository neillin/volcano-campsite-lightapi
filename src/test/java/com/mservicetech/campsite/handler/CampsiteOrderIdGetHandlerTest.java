...
public class CampsiteOrderIdGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(CampsiteOrderIdGetHandlerTest.class);
    ...
    @Test
    public void testCampsiteOrderIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/api/campsite/TWetwLXMspKrLfTCBDl";

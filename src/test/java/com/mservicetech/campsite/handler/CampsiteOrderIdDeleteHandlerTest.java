...
public class CampsiteOrderIdDeleteHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(CampsiteOrderIdDeleteHandlerTest.class);
    ...
    @Test
    public void testCampsiteOrderIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/api/campsite/fjkcwguKlKURIe";

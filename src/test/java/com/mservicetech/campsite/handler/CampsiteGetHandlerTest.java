...
public class CampsiteGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(CampsiteGetHandlerTest.class);
    ...
    @Test
    public void testCampsiteGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/api/campsite?startDate=tJDSmIKHVLbYYCtaVbzVgCSXeGH&endDate=PWGhdDUkhOmSwQneGjvFKdXMjpIm";

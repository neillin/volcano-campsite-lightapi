...
public class CampsiteOrderIdPutHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(CampsiteOrderIdPutHandlerTest.class);
    ...
    @Test
    public void testCampsiteOrderIdPutHandlerTest() throws ClientException {
        ...
        String requestUri = "/api/campsite/JdbxmX";

...
public class CampsiteOrderIdDeleteService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(CampsiteOrderIdDeleteService.class);

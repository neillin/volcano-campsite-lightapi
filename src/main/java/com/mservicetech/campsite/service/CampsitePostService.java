...
public class CampsitePostService implements HttpService<Reservation, String> {
    private static final Logger logger = LoggerFactory.getLogger(CampsitePostService.class);

...
public class CampsiteOrderIdGetService implements HttpService<Void, String> {
    private static final Logger logger = LoggerFactory.getLogger(CampsiteOrderIdGetService.class);

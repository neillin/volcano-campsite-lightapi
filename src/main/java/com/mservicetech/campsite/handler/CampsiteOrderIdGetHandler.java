...
import com.mservicetech.campsite.service.CampsiteOrderIdGetService;
...
public class CampsiteOrderIdGetHandler implements LightHttpHandler {
    CampsiteOrderIdGetService service;

    public CampsiteOrderIdGetHandler () {
        this.service = new CampsiteOrderIdGetService ();
    }

...
import com.mservicetech.campsite.service.CampsiteOrderIdDeleteService;
...
public class CampsiteOrderIdDeleteHandler implements LightHttpHandler {
    CampsiteOrderIdDeleteService service;

    public CampsiteOrderIdDeleteHandler () {
        this.service = new CampsiteOrderIdDeleteService ();
    }
